package dswork.android.lib.view.v40.base.getbyid;
...
import dswork.android.lib.view.v40.OleSherlockActivity;

public abstract class BaseGetByIdOleSherlockActivity<T> extends OleSherlockActivity
{
	/**
