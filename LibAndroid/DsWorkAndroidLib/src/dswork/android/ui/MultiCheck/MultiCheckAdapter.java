...
public class MultiCheckAdapter extends BaseAdapter 
{
	...
	private int itemIdRes;//每条item记录的主键TextView
	private int itemChkRes;//每条item记录的CheckBox
	 ...
	 * @param itemIdRes 每条item记录的主键TextView资源
	 * @param itemChkRes 每条item记录的CheckBox资源
	 * @param from 需显示的model属性名,字符串数组String[]
	 * @param to 属性名绑定的View控件id,整形数组int[]
	 */
	public MultiCheckAdapter(Context context, List dataList, int resource, int itemIdRes, int itemChkRes, String[] from, int[] to, ViewCache vc) 
	{
