...
$(function()
{
	$dswork.page.menu("del.htm", "upd1.htm", "getById.htm", ${pageModel.currentPage});
});
</script>
...
<table border="0" cellspacing="0" cellpadding="0" class="listLogo">
	<tr>
		...
		<td class="menuTool">
			<a class="add" href="add1.htm?page=${pageModel.currentPage}">添加</a>
			<a class="del" id="listFormDelAll" href="#">删除所选</a>
		</td>
	</tr>
</table>
<div class="line"></div>
<form id="queryForm" method="post" action="get.htm">
<table border="0" cellspacing="0" cellpadding="0" class="queryTable">
	<tr>
		<td class="title">标题：</td>
		<td class="input"><input type="text" name="title" value="${fn:escapeXml(param.title)}" /></td>
	</tr>
	<tr>
		<td class="title">内容：</td>
		<td class="input"><input type="text" name="content" value="${fn:escapeXml(param.content)}" /></td>
	</tr>
	<tr>
		<td class="title">创建时间：</td>
		<td class="input"><input type="text" name="foundtime" value="${fn:escapeXml(param.foundtime)}" /></td>
	</tr>
	<tr>
...
<c:forEach items="${pageModel.result}" var="d">
	<tr>
		...
		<td>${d.foundtime}</td>
		<td class="menuTool">
			<a class="upd" href="upd1.htm?keyIndex=${d.id}">修改</a>
			<a class="del" href="del.htm?keyIndex=${d.id}">删除</a>
		</td>
	</tr>
</c:forEach>
</table>
