...
<head>
	...
	$dswork.callback = function()
	{
		...
		{
			location.href = "get.htm?page=${page}";
		}
	}
	</script>
</head>
...
<table border="0" cellspacing="0" cellpadding="0" class="listLogo">
	<tr>
		...
		<td class="menuTool">
			...
			<a class="back" href="get.htm?page=${page}">返回</a>
		</td>
	</tr>
</table>
<div class="line"></div>
...
<table border="0" cellspacing="1" cellpadding="0" class="listTable">
	...
	<tr>
		...
		<td class="form_input"><input type="text" name="foundtime" value="${fn:escapeXml(po.foundtime)}" /></td>
	</tr>
</table>
