...
import="java.io.File,java.net.URLDecoder,dswork.core.upload.JskeyUpload,dswork.web.*"
%><%!
...
try
{
	...
	MyRequest req = new MyRequest(request, JskeyUpload.UPLOAD_MAXSIZE, JskeyUpload.UPLOAD_MAXSIZE, ext, null);
