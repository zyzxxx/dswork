...
function doAjaxFileUpload()
{
	...
	{
		$jskey.upload.init({
			url:'../jskey_multiupload.jsp?<%--uploadone=true&--%>sessionkey=<%=JskeyUpload.refreshSessionKey(request)%>&filekey=' + _filekey + '&ext=' + _ext,
...
{
	doAjaxFileUpload("spanUploadButton", "<%=System.currentTimeMillis() %>", "fjFile", "fjFileNames", null, "divUploadProgress");
};
</script>
</head>
<body>
...
<form id="dateForm" action="jskey_multiupload_demo2.jsp" method="post">
<%--key--%>
