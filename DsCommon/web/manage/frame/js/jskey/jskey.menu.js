...
create:function(){
	...
	for(var i = 0;i < len;i++){html += this.createCell(this.list[i], i);}
	html += this.createCell({"title":"", "menuId":"", "html":"&nbsp;"}, len);// 在最后补一个看不见的，用于收缩
	html += '</table>';
	try{if(this.$("JskeyMenuG") != null){document.body.removeChild(this.$("JskeyMenuG"));}}catch(e){}
...
$jskey.menu.changeURL = function(parentname, nodename, url){
	...
	if(url != ""){try	{
		...
		parent.navigation.addUrl(nodename, "");
