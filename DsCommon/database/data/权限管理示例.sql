...
INSERT INTO DS_COMMON_USER (ID, ORGID, ROLEID) VALUES (21, 8, 1);
...
INSERT INTO DS_COMMON_USERTYPE (ID, NAME, ALIAS, STATUS, SEQ, MEMO, RESOURCES) VALUES (1, '管理用户', LOWER('0'), 1, 1, '', '');
INSERT INTO DS_COMMON_USERTYPE (ID, NAME, ALIAS, STATUS, SEQ, MEMO, RESOURCES) VALUES (2, '个人用户', LOWER('1'), 1, 2, '', '');
INSERT INTO DS_COMMON_USERTYPE (ID, NAME, ALIAS, STATUS, SEQ, MEMO, RESOURCES) VALUES (3, '企业用户', LOWER('2'), 1, 3, '', '1|企业管理员
0|普通用户');


INSERT INTO DS_COMMON_USER (ID, ACCOUNT, PASSWORD, NAME, IDCARD, STATUS, EMAIL, MOBILE, PHONE, WORKCARD, CAKEY, CREATETIME, ORGPID, ORGID, TYPE, TYPENAME, EXALIAS, EXNAME) VALUES (-1, 'admin', '670B14728AD9902AECBA32E22FA4F6BD', '超级管理员', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, 1, 2, '0', '管理用户', '', '');
INSERT INTO DS_COMMON_USER (ID, ACCOUNT, PASSWORD, NAME, IDCARD, STATUS, EMAIL, MOBILE, PHONE, WORKCARD, CAKEY, CREATETIME, ORGPID, ORGID, TYPE, TYPENAME, EXALIAS, EXNAME) VALUES (1, 'user', '670B14728AD9902AECBA32E22FA4F6BD', '用户', '', 1, '', '', '', '', '', '2014-06-04 16:13:30', 3, 6, '0', '管理用户', '', '');
INSERT INTO DS_COMMON_USER (ID, ACCOUNT, PASSWORD, NAME, IDCARD, STATUS, EMAIL, MOBILE, PHONE, WORKCARD, CAKEY, CREATETIME, ORGPID, ORGID, TYPE, TYPENAME, EXALIAS, EXNAME) VALUES (2, 'useradmin', '670B14728AD9902AECBA32E22FA4F6BD', '用户', '', 1, '', '', '', '', '', '2014-06-04 16:14:06', 3, 8, '0', '管理用户', '', '');
INSERT INTO DS_COMMON_USER (ID, ACCOUNT, PASSWORD, NAME, IDCARD, STATUS, EMAIL, MOBILE, PHONE, WORKCARD, CAKEY, CREATETIME, ORGPID, ORGID, TYPE, TYPENAME, EXALIAS, EXNAME) VALUES (3, 'z1', '670B14728AD9902AECBA32E22FA4F6BD', '张一', '', 1, '', '', '', '', '', '2014-06-10 11:18:27', 3, 6, '0', '管理用户', '', '');
INSERT INTO DS_COMMON_USER (ID, ACCOUNT, PASSWORD, NAME, IDCARD, STATUS, EMAIL, MOBILE, PHONE, WORKCARD, CAKEY, CREATETIME, ORGPID, ORGID, TYPE, TYPENAME, EXALIAS, EXNAME) VALUES (4, 'z2', '670B14728AD9902AECBA32E22FA4F6BD', '张二', '', 1, '', '', '', '', '', '2014-06-10 11:18:39', 3, 6, '0', '管理用户', '', '');
INSERT INTO DS_COMMON_USER (ID, ACCOUNT, PASSWORD, NAME, IDCARD, STATUS, EMAIL, MOBILE, PHONE, WORKCARD, CAKEY, CREATETIME, ORGPID, ORGID, TYPE, TYPENAME, EXALIAS, EXNAME) VALUES (5, 'z3', '670B14728AD9902AECBA32E22FA4F6BD', '张三', '', 0, '', '', '', '', '', '2014-06-10 11:18:50', 3, 6, '0', '管理用户', '', '');
INSERT INTO DS_COMMON_USER (ID, ACCOUNT, PASSWORD, NAME, IDCARD, STATUS, EMAIL, MOBILE, PHONE, WORKCARD, CAKEY, CREATETIME, ORGPID, ORGID, TYPE, TYPENAME, EXALIAS, EXNAME) VALUES (6, 'h1', '670B14728AD9902AECBA32E22FA4F6BD', '黄一', '', 1, '', '', '', '', '', '2014-06-10 11:19:25', 2, 4, '0', '管理用户', '', '');
INSERT INTO DS_COMMON_USER (ID, ACCOUNT, PASSWORD, NAME, IDCARD, STATUS, EMAIL, MOBILE, PHONE, WORKCARD, CAKEY, CREATETIME, ORGPID, ORGID, TYPE, TYPENAME, EXALIAS, EXNAME) VALUES (7, 'h2', '670B14728AD9902AECBA32E22FA4F6BD', '黄二', '', 1, '', '', '', '', '', '2014-06-10 11:19:33', 2, 4, '0', '管理用户', '', '');
INSERT INTO DS_COMMON_USER (ID, ACCOUNT, PASSWORD, NAME, IDCARD, STATUS, EMAIL, MOBILE, PHONE, WORKCARD, CAKEY, CREATETIME, ORGPID, ORGID, TYPE, TYPENAME, EXALIAS, EXNAME) VALUES (8, 'h3', '670B14728AD9902AECBA32E22FA4F6BD', '黄三', '', 0, '', '', '', '', '', '2014-06-10 11:19:44', 2, 4, '0', '管理用户', '', '');


INSERT INTO DS_COMMON_USERROLEORG (ID, ORGID, USERID) VALUES (22, 8, 6);
