...
CREATE TABLE `ds_xzsp` (
  `ID` bigint(18) NOT NULL COMMENT '主键',
  `SBLSH` varchar(30) DEFAULT NULL COMMENT '申办流水号',
...
INSERT INTO `ds_person_user` VALUES ('1','440111180012310004','440111180012310004','E3BA7E699F89B594FA58268130725BE2','屌爆天逗比技术特攻队','1','','',NULL,NULL,NULL,'1');
INSERT INTO `gx_user` VALUES ('16','123456789987654321','他妹的傻逼公司','','1','1','',''), ('17','100000','屌爆天逗比技术特攻队','','1','1','','');
