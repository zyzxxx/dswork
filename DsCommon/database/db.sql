...
(
   ...
   CONSTRAINT FK_DS_COMMON_FUNC FOREIGN KEY (PID)
      REFERENCES DS_COMMON_FUNC (ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
(
   ...
   CONSTRAINT FK_DS_COMMON_ROLE FOREIGN KEY (PID)
      REFERENCES DS_COMMON_ROLE (ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
(
   ...
   CONSTRAINT FK_DS_COMMON_ROLEFUNC_ROLE FOREIGN KEY (ROLEID)
      REFERENCES DS_COMMON_ROLE (ID) ON DELETE CASCADE ON UPDATE RESTRICT
);
