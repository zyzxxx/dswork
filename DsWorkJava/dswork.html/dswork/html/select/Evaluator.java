...
import dswork.html.nodes.NodeComment;
...
public abstract class Evaluator
{
	...
	public static final class AttributeStarting extends Evaluator
	{
		...
		public boolean matches(Element root, Element element)
		{
			List<dswork.html.nodes.Attribute> values = element.attributes().asList();
			for(dswork.html.nodes.Attribute attribute : values)
			{
	...
	public static final class AttributeWithValueStarting extends AttributeKeyPair
	{
		...
		public boolean matches(Element root, Element element)
		{
			return element.hasAttr(key) && element.attr(key).toLowerCase().startsWith(value); // value is lower case
																								// already
		}
	...
	public static class IsNthOfType extends CssNthEvaluator
	{
		...
		{
			int pos = 0;
			List<Element> family = element.parent().children();
	...
	public static final class IsOnlyOfType extends Evaluator
	{
		...
		public boolean matches(Element root, Element element)
		{
			...
			if(p == null || p instanceof Document)
				return false;
			int pos = 0;
			List<Element> family = p.children();
			for(Element el : family)
			{
				if(el.tag().equals(element.tag()))
					pos++;
	...
	public static final class IsEmpty extends Evaluator
	{
		...
		public boolean matches(Element root, Element element)
		{
			...
			for(Node n : family)
			{
				if(!(n instanceof NodeComment || n instanceof NodeDocumentType))
					return false;
			}
			return true;
		}
