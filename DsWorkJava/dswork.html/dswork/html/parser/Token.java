...
abstract class Token
{
	...
	static abstract class Tag extends Token
	{
		...
		Attributes attributes; // start tags get attributes on construction. End tags get attributes on first new
								// attribute (but only for parser convenience, not used).
