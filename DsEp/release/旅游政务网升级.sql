...
select ID,SITEID,CATEGORYID,STATUS,TITLE,SCOPE,URL,METAKEYWORDS,METADESCRIPTION,SUMMARY,RELEASETIME,RELEASESOURCE,RELEASEUSER,IMG,IMGTOP,PAGETOP,CONTENT from DS_CMS_PAGE;
