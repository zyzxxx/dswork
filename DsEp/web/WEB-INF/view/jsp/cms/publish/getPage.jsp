...
$dswork.page.join = function(td, menu, id){
	$(menu).append($('<div iconCls="menuTool-graph">预览</div>').bind("click", function(){
		window.open("${ctx}/cms/page/buildHTML.chtml?view=true&siteid=${po.siteid}&categoryid=${po.id}&pageid=" + id);
	}));
...
<table border="0" cellspacing="0" cellpadding="0" class="listLogo">
	<tr>
		...
		<td class="menuTool">
			...
			<a class="look" target="_blank" href="${ctx}/cms/page/buildHTML.chtml?view=true&siteid=${po.siteid}&categoryid=${po.id}">预览栏目首页</a>
			&nbsp;<a class="vline" href="#"></a>&nbsp;
