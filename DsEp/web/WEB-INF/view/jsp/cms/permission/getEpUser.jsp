...
function empower(account){
	$jskey.dialog.showDialog({url:"${ctx}/cms/permission/updPermission1.htm?account="+account,title:"分配权限",fit:true,draggable:true});
}
</script>
</head> 
<body>
<table border="0" cellspacing="0" cellpadding="0" class="listLogo">
	<tr>
		<td class="title">${ssdw}企业用户采编授权</td>
	</tr>
</table>
<div class="line"></div>
<form id="queryForm" method="post" action="getEpUser.htm">
...
<table id="dataTable" border="0" cellspacing="1" cellpadding="0" class="listTable">
	<tr class="list_title">
		<td>姓名(帐号)</td>
		<td style="width:16.6%">手机</td>
		<td style="width:16.6%">Email</td>
		<td style="width:16.6%">用户类型</td>
		<td style="width:16.6%;">状态</td>
		<td style="width:16.6%;">授权</td>
	</tr>
