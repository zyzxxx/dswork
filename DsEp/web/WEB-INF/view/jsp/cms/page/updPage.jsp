...
$(function(){
	...
	$('#content').xheditor({html5Upload:true,upMultiple:1,upLinkUrl:"uploadFile.htm?categoryid=${po.categoryid}",upImgUrl:"uploadImage.htm?zoom=true&categoryid=${po.categoryid}",internalScript:true});
	function show(){
		var i = new Image();
		i.src = $("#inputImg").val();
