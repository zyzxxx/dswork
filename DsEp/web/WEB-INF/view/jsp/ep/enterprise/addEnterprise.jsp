...
<table border="0" cellspacing="1" cellpadding="0" class="listTable">
	...
	<tr>
		...
		<td class="form_input"><input type="text" name="qybm" maxlength="100" style="width:100px;" dataType="Char" dataType="RequireTrim" dataType="Require" value="" /> <span class="imp">*</span> <span style="font-weight:bold;">添加后不可修改</span></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="form_input"><input type="text" name="idcard" style="width:200px;" require="false" dataType="IdCard" maxlength="18" value="" /></td>
	</tr>
	<tr>
		<td class="form_title">邮箱：</td>
		<td class="form_input"><input type="text" name="email" readonly="readonly" style="width:200px;" require="false" dataType="Email" maxlength="250" value="" /></td>
	</tr>
	<tr>
		<td class="form_title">手机：</td>
		<td class="form_input"><input type="text" name="mobile" require="false" dataType="Mobile" maxlength="50" value="" /></td>
	</tr>
	<tr>
		<td class="form_title">电话：</td>
		<td class="form_input"><input type="text" name="phone" require="false" dataType="Phone" maxlength="50" value="" /></td>
	</tr>
	<tr>
		<td class="form_title">传真：</td>
		<td class="form_input"><input type="text" name="fax" require="false" dataType="Fax" maxlength="50" value="" /></td>
	</tr>
</table>
