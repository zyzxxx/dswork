...
%>{<%
	...
	%>,"dataurl":"http://192.168.1.10/www-visitgz/m/cms/category.jsp?siteid=7"<%
	...
	%>,"icoArray":[<%
			...
			%>,{"name":"展览会","type":"func","img":"/www-visitgz/m/cms/visitgz/ico/zl.png"     ,"param":"categoryids=13,14,15,16&pagesize=5&page="}<%
			%>,{"name":"资讯网","type":"url", "img":"/www-visitgz/m/cms/visitgz/ico/visitgz.png","url":"http://192.168.1.10"}<%
			%>,{"name":"提醒"  ,"type":"func","img":"/www-visitgz/m/cms/visitgz/ico/tx.png"     ,"url":"categoryids=22,23,24,25,26&&pagesize=5&page="}<%
	%>]<%
