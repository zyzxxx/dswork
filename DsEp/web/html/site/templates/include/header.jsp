...
<div class="nav">
    <ul class="left">
        ...
        <li><a href="${ctx}/a/gkzn/index.html">政务公开</a></li>
        ...
        <li class="last"><a target="_blank" href="http://www.visitgz.gov.cn/">资讯网</a></li>
    </ul>
</div>
--%>
...
<div style="width:990px;height:0px;margin:0 auto;position:relative;background:none;z-index:999;">
	...
	<div class="tlink" style="position:absolute;top:10px;right:5px;height:20px;">
		<a href="http://www.visitgz.gov.cn">广州旅游资讯网</a> /
		<a href="http://weibo.com/gzly">广州旅游微博</a>
	</div>
</div>
<div id="showid1" style="width:100%;height:400px;margin:0 0 10px 0;overflow:hidden;background-color:#fff;clear:both;">
	<div class="jskey_focus">
		<ul>
			<li><a><img src="${ctx}/f/res/index/1.jpg"/></a></li>
			<li><a><img src="${ctx}/f/res/index/2.jpg"/></a></li>
			<li><a><img src="${ctx}/f/res/index/3.jpg"/></a></li>
		</ul>
	</div>
</div>
<script type="text/javascript">
	$jskey.focus({target:"showid1",arrow:true,button:true,mode:"fit"});//,mode:"fit"
</script>
...
.nav-my .nav-down dt a {padding:0;}
.nav-my .nav-down dt a:hover{color:yellow;}
.nav-my .nav-down dd a {padding:0;}
...
<div style="width:990px;height:44px;margin:0 auto;">
  <div id="v1" class="nav-tool nav-my">
	<div class="nav-up">
		<ul>
			<li><a href="${ctx}/index.html">网站首页</a></li>
	        <li data-nav="63"><a href="${ctx}/a/gkzn/index.html">政务公开</a></li>
	        <li data-nav="41"><a href="${ctx}/a/gzdt2/index.html">工作动态</a></li>
	        <li data-nav="64"><a href="${ctx}/a/gzhdbz/index.html">公众互动</a></li>
	        <li data-nav="59"><a href="${ctx}/a/tzgsgg/index.html">通知公告</a></li>
	        <%--<li data-nav="77"><a href="http://wsbs.gz.gov.cn/gz/index.jsp" target="_blank">办事大厅</a></li>--%>
	        <li><a href="http://wsbs.gz.gov.cn/gz/index.jsp" target="_blank">办事大厅</a></li>
	        <li data-nav="81"><a href="${ctx}/a/zdly/index.html">重点领域</a></li>
	        <li>
		        <div style="background-color:white;border-radius:5px;margin:10px;">
		        	<input type="text" id="vv" style="margin-left:10px;border:0px;width:145px;height:24px;line-height:24px;" placeholder="请输入关键字" value=""/>
		        	&nbsp;&nbsp;<img onclick="var _x=document.getElementById('vv').value;if(_x!=''){location.href='${ctx}/a/search/index.html?v='+encodeURIComponent(encodeURIComponent(_x));}" style="width:16px;height:18px;margin-right:10px;cursor:pointer;" alt="" src="${ctx}/themes/images/search.png"/>
		        </div>
	        </li>
		</ul>
	</div>
