...
.nav-my .nav-down dt a:link,
.nav-my .nav-down dt a:active,
.nav-my .nav-down dt a:visited {color:#ccc;}
.nav-my .nav-down dt a:hover{color:yellow;}
.nav-my .nav-down dd a {color:#aaa;}
.nav-my .nav-down dd a:link,
.nav-my .nav-down dd a:active,
.nav-my .nav-down dd a:visited {color:#aaa;}
