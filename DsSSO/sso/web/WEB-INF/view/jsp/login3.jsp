...
div,input,label{color:#A46B0D;}
a{text-decoration:underline;outline:none;}
a:link,a:visited,a:active{color:#A46B0D;outline:none;}
a:hover{color:#D18910;text-decoration:underline;}
.bg{width:100%;height:730px;position:absolute;top:0px;left:0;z-index:-1;background:url(/mall/themes/img/login_bg.png) no-repeat top center;}
.view{position:relative;width:100%;min-width:300px;max-width:1000px;overflow:hidden;margin:0 auto;overflow:hidden;}
.title {color:#EFC74A;font-size:38px;font-weight:bold;text-align:left;padding:80px 50px 38px 50px;}
...
.box .title{background-color:#fff;border-bottom:#ccc solid 1px;color:#D18910;width:100%;padding:3px 0;line-height:50px;font-size:22px;text-align:center;margin:0 auto;}
.box .vbox{margin:0 auto;padding:0;overflow:hidden;text-align:left;vertical-align:middle;width:250px;}
.box .vbox span{font-family:dsworkfont;margin:0 10px;color:#D18910;}
...
.box .button{background-color:#A46B0D;color:#eee;width:280px;height:50px;line-height:50px;cursor:pointer;border:none;-webkit-appearance:none;}
.box .button:hover{background-color:#D18910;color:#fff;}
