...
//		posPoint.initPosPoint(fgms.size(),"●","#ff0000","#DDDDDD",255,1);
	...
	public static class Fragment3 extends Fragment
	{
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) 
		{
			...
			WorkUtil.addShortcut(getActivity(), rootView, R.id.webapp, R.drawable.ic_launcher, "webApp", WorkUtil.getAppIntent("dswork.android", "dswork.android.demo.framework.app.web.Main_A", false, null, null, null));
			WorkUtil.addShortcut(getActivity(), rootView, R.id.singleapp, R.drawable.ic_launcher, "singleApp", WorkUtil.getAppIntent("dswork.android", "dswork.android.demo.framework.app.single.PersonGet_A",false, null, null, null));
			return rootView;
		}
	}
}
